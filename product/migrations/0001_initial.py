...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='Ingredient',
            fields=[
                ('nutraceuticals_name', models.CharField(max_length=100, primary_key=True, serialize=False)),
        ...
        migrations.CreateModel(
            name='Nutraceuticals',
            fields=[
                ('nutraceuticals_id', models.BigAutoField(primary_key=True, serialize=False)),
        ...
        migrations.CreateModel(
            name='OnelineReview',
            fields=[
                ('online_review_id', models.BigAutoField(primary_key=True, serialize=False)),
        ...
        migrations.CreateModel(
            name='UserReview',
            fields=[
                ('user_review_id', models.BigAutoField(primary_key=True, serialize=False)),
                ('review_rating', models.IntegerField()),
                ('review_contents', models.CharField(max_length=500)),
                ('user', models.ForeignKey(db_column='member_id', on_delete=django.db.models.deletion.DO_NOTHING, to=settings.AUTH_USER_MODEL)),
            ],
            options={
