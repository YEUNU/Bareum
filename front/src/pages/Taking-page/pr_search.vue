<template>
  <div class="mycontainer">
    ...
    <div class="search-bar-wrapper" style="margin-top: 10%;">
      <div class="search-bar" style="display: flex; flex-wrap: nowrap; justify-content: center;">
        <input type="text" placeholder="검색어 입력" v-model="searchQuery" @keyup.enter="handleSearch" />
        <button @click="handleSearch" style="background-color: rgba(0, 0, 0, 0); border: none;">
          <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="#2dce89" class="bi bi-search"
            viewBox="0 0 16 16">
            <path
