    ...
    <div v-else style="margin-bottom: 70px">
        ...
        <div>
            <div class="rank_box" v-for="(product, i) in filtered_dataset.sort(function(a, b) { return b[age_group] - a[age_group];})" :key="i">
                ...
                <div class="rank_name">제품명: {{product['name']}}</div>
                <div class="rank_mount">판매량: {{product[age_group]}}</div>
                <div class="rank_price">가격: {{product['price']}}</div>
            </div>
        </div>
    </div>
...
setup() {
    ...
    const example_data = ref([
        { id: 1, name: '견본1', personalize: '눈 건강',    ingredient: '오메가3',     price: 3413,     total: 43291,    age1: 5427,     age2: 64,
        ...
        { id: 2, name: '견본2', personalize: '혈당',       ingredient: '비타민c',     price: 888454,   total: 64354,    age1: 7574,     age2: 6458,
        img: "https://src.hidoc.co.kr/image/lib/2017/11/27/20171127123357561_0.jpg" },
        { id: 3, name: '견본3', personalize: '체지방',     ingredient: '칼슘',        price: 68521,    total: 354,      age1: 225,      age2: 8654,
        img: "https://mikookvitamin.com/wp-content/uploads/2022/08/1-44.jpg" },
        { id: 4, name: '견본4', personalize: '혈압',       ingredient: '레시틴',      price: 35488,    total: 6783456,  age1: 58574,    age2: 5648,
        img: "https://www.mindpharm.co.kr/shopimages/hsbchong7/010000000558.jpg?1665123386" },
        { id: 5, name: '견본5', personalize: '간 건강',    ingredient: '쏘팔메토',    price: 676417,   total: 543453,   age1: 547,      age2: 468,
        img: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRuz3Nvk3gHgGE8ty_xDNv1N8IyG1tlI_MgQg&usqp=CAU" },
        { id: 6, name: '견본6', personalize: '빈혈',       ingredient: '글루코사민',  price: 111,       total: 7545852,  age1: 274,      age2: 84563,
        img: "https://blog.kakaocdn.net/dn/ccSTa7/btq2iVJYeeO/MnhO8BM97mX9AKcKVujXrk/img.png" },
        { id: 7, name: '견본7', personalize: '피로감',     ingredient: '엽산',        price: 564354,   total: 42524,    age1: 23,       age2: 4,
        img: "https://wiselycompany.com/web/product/medium/202304/e64cb84719683d853ef26b0a2807274f.png" },
        { id: 8, name: '견본8', personalize: '피로감',     ingredient: '아연',        price: 54386841, total: 7423,     age1: 78,       age2: 5574,
        img: "https://gdimg.gmarket.co.kr/2506504936/still/280?ver=1666777374" },
        { id: 9, name: '견본9', personalize: '체지방',     ingredient: '마그네슘',    price: 121111,   total: 4755,     age1: 527527,   age2: 15,
