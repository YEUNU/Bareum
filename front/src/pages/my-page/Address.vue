<template>
  ...
  <form @submit.prevent="saveAddress">
        ...
        <div class="card-body">
          ...
          <div style="display: flex; align-items: flex-end; flex-wrap: nowrap; margin-top: 6%;">
            ...
            <input type="text" v-model="postcode" placeholder=" "
              style="width: 60%; background-color: white; color: black; border: none; border-bottom: 1px solid gray;">
            <input type="button" @click="execDaumPostcode" value="찾기"
              style="width: 9vh; background-color: #2dce89; color:white; border: 1px solid; border-radius: 5px; margin-left: 5%;">
          </div>
    ...
    <button
      style="width:100%; margin-bottom: 50%; background-color: #2dce89; border-radius: 5px; color:white; box-shadow: 2px 2px 2px 2px #eeeeee">저장</button>
  </form>
</template>
