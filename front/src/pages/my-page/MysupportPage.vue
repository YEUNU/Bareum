    ...
    <div class="container">
        <nav class="navbar fixed-top bg-light">
            ...
            <div style="margin-top: 3%;">
                <span class="navbar-brand mb-0" style="padding: 2.2vh;">문의하기</span>
                <span class="navbar-brand mb-0" style="padding: 8.8vh;">카카오계정으로 답변이 도착합니다.</span>
            </div>
        </nav>
        
        <div class="supcontent">
            <div class="row">
                <div class="col-9" style="padding-right: 55%;">
                    <h4>문의 유형</h4>
                </div>
                <div class="col-9">
            ...
            <div class="submit"><button style="background-color: #2dce89; color: white; border-radius: 5px;">제출하기</button></div>
    </div>
</template>
