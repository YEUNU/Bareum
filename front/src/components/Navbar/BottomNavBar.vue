<template lang="">
  ...
  <ul>
    <li :class="{active: homepage}">
      <router-link to="/">
  <span class="nav-icon">
    <svg xmlns="http://www.w3.org/2000/svg" v-if="homepage" width="40" height="40" fill="#2dce89" class="bi bi-house-door-fill" viewBox="0 0 16 16">
      <path d="M6.5 14.5v-3.505c0-.245.25-.495.5-.495h2c.25 0 .5.25.5.5v3.5a.5.5 0 0 0 .5.5h4a.5.5 0 0 0 .5-.5v-7a.5.5 0 0 0-.146-.354L13 5.793V2.5a.5.5 0 0 0-.5-.5h-1a.5.5 0 0 0-.5.5v1.293L8.354 1.146a.5.5 0 0 0-.708 0l-6 6A.5.5 0 0 0 1.5 7.5v7a.5.5 0 0 0 .5.5h4a.5.5 0 0 0 .5-.5Z"/>
    </svg>
    <svg xmlns="http://www.w3.org/2000/svg" v-else width="40" height="40" fill="currentColor" class="bi bi-house-door" viewBox="0 0 16 16">
    ...
    <li :class="{active: shop}">
      <router-link to="/shop">
  <span class="nav-icon">
    <svg xmlns="http://www.w3.org/2000/svg" v-if="shop" width="40" height="40" fill="#2dce89" class="bi bi-cart-fill" viewBox="0 0 16 16">
      <path d="M0 1.5A.5.5 0 0 1 .5 1H2a.5.5 0 0 1 .485.379L2.89 3H14.5a.5.5 0 0 1 .491.592l-1.5 8A.5.5 0 0 1 13 12H4a.5.5 0 0 1-.491-.408L2.01 3.607 1.61 2H.5a.5.5 0 0 1-.5-.5zM5 12a2 2 0 1 0 0 4 2 2 0 0 0 0-4zm7 0a2 2 0 1 0 0 4 2 2 0 0 0 0-4zm-7 1a1 1 0 1 1 0 2 1 1 0 0 1 0-2zm7 0a1 1 0 1 1 0 2 1 1 0 0 1 0-2z"/>
    </svg>
    <svg xmlns="http://www.w3.org/2000/svg" v-else width="40" height="40" fill="currentColor" class="bi bi-cart" viewBox="0 0 16 16">
  ...
  <span class="nav-icon">
    <svg xmlns="http://www.w3.org/2000/svg" v-if="community" width="40" height="40" fill="#2dce89" class="bi bi-chat-left-fill" viewBox="0 0 16 16">
      <path d="M0 2a2 2 0 0 1 2-2h12a2 2 0 0 1 2 2v8a2 2 0 0 1-2 2H4.414a1 1 0 0 0-.707.293L.854 15.146A.5.5 0 0 1 0 14.793V2zm3.5 1a.5.5 0 0 0 0 1h9a.5.5 0 0 0 0-1h-9zm0 2.5a.5.5 0 0 0 0 1h9a.5.5 0 0 0 0-1h-9zm0 2.5a.5.5 0 0 0 0 1h5a.5.5 0 0 0 0-1h-5z"/>
    </svg>
    <svg xmlns="http://www.w3.org/2000/svg" v-else width="40" height="40" fill="currentColor" class="bi bi-chat-left" viewBox="0 0 16 16">
  ...
  <span class="nav-icon">
    <svg xmlns="http://www.w3.org/2000/svg" v-if="mypage" width="40" height="40" fill="#2dce89" class="bi bi-person-fill" viewBox="0 0 16 16">
      <path d="M3 14s-1 0-1-1 1-4 6-4 6 3 6 4-1 1-1 1H3Zm5-6a3 3 0 1 0 0-6 3 3 0 0 0 0 6Z"/>
    </svg>
    <svg xmlns="http://www.w3.org/2000/svg" v-else width="40" height="40" fill="currentColor" class="bi bi-person" viewBox="0 0 16 16">
